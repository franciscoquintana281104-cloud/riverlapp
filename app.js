...
const PAUSAS = {
  corta: [
    ...
    'Fumercio exprés',
    'Agua. Un vaso. Ya.',
    'Estírate como si supieras hacerlo',
    'Cambio de escenario y poco más',
  ],
  media: [
    'Hidratación y fumercio extremo',
    'Cola del baño ahora que no hay',
    'Cerveza, cigarro y vuelta',
    'Sentarse. Literalmente sentarse.',
    'Cargar el móvil como si te fuera la vida',
    'Buscar a los que se han perdido',
    'Bocadillo de emergencia',
  ],
  larga: [
    'Esto es una cena en condiciones',
    'Siesta táctica en la hierba',
    'Hidratación, fumercio extremo y reflexión vital',
    'Vuelta a la tienda a por chaqueta',
    'Hora de reconstruir el grupo entero',
